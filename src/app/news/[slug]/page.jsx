    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] font-sans text-[#0f172a]">
        ...
        <div className="py-40 text-center">
          ...
          <Link href="/news" className="text-[#004A99] font-bold hover:underline">Back to All News</Link>
        </div>
        <Footer />
      </div>
    );
    ...
    <div className="min-h-screen bg-[#f8fafc] font-sans text-[#0f172a]">
      ...
      <article className="pt-12 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <Link href="/news" className="inline-flex items-center gap-2 text-[#004A99] font-bold mb-10 hover:underline">
            ...
            <div className="flex-1 min-w-0">
              <div 
                className="article-content text-slate-600 text-lg leading-[1.8] prose prose-slate max-w-none break-words
                  ...
                  prose-p:mb-8 prose-li:mb-2 prose-strong:text-slate-900 prose-img:rounded-3xl prose-img:mx-auto prose-a:text-[#004A99] prose-a:font-bold prose-a:no-underline hover:prose-a:underline
